                            ...
                            <form method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="schema" id="schema" class="form-control">
                                        ...
                                        {foreach from=$schemas item=schema}
                                            <option value="{$schema->getNameNoExtension()}" nummod="{YujuView::getNumModulesBySchema($schema->getNameNoExtension())}" {if $schema->getNameNoExtension() == $page->getSchema()}selected="selected"{/if} onchange="updateSchema();">{$schema->getNameNoExtension()}</option>
                                        {/foreach}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        {$num=2}
                                        {for $i=1 to YujuView::getNumModulesBySchema($page->getSchema())}
                                            {if $num==4}
                                                </div>
                                                <div class="row">
                                                {$num=0}
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="parent" class="form-control">
                                        <option value=""></option>
                                        {foreach YujuView::getAll() as $pages}
