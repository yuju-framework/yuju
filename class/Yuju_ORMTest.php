...
class Yuju_ORMTest
{
    ...
    public function generateGetterSetter()
    {
        ...
        foreach ($this->fields as $name => $field) {
            ...
            if ($field['type'] == 'varchar' || $field['type'] == 'char' || $field['type'] == 'longtext'
                ...
                $object .= "    {\n";
                $object .= '        $this->setUp();'."\n";
                $object .= '        $this->assertTrue($this->_' . strtolower($this->object_name) .
                    '->setNombre("aaa"));'."\n";
                $object .= '        $this->assertEquals($this->_' . strtolower($this->object_name) .
                    '->getNombre(),"aaa");'."\n";
                $object .= "    }\n\n";
            }
            ...
            switch ($field['type']) {
                case 'date':
                    ...
                    $object .= '        $this->_' . strtolower($this->object_name) .'->get'.
                        ucfirst($name).'()->setDate(25, 11, 2000);'."\n";
                    $object .= '        $this->assertEquals($fecha->getDay(),$this->_' .
                        strtolower($this->object_name) .'->get'.ucfirst($name). '()->getDay());'."\n";
                    $object .= '        $this->assertEquals($fecha->getMonth(),$this->_' .
                        strtolower($this->object_name) .'->get'.ucfirst($name). '()->getMonth());'."\n";
                    $object .= '        $this->assertEquals($fecha->getYear(),$this->_' .
                        strtolower($this->object_name) .'->get'.ucfirst($name). '()->getYear());'."\n";
                    break;
                case 'datetime':
                    $object .= '        $objDateTime = new Date();'."\n";
                    $object .= '        $objDateTime->setDateTime(11, 12, 2000, 14, 10, 12);'."\n";
                    $object .= '        $this->_' . strtolower($this->object_name) .'->get'.ucfirst($name).
                        '()->setDateTime(11, 12, 2000, 14, 10, 12);'."\n";
                    $object .= '        $this->assertEquals($objDateTime->getDay(),$this->_' .
                        strtolower($this->object_name) .'->get'.ucfirst($name). '()->getDay());'."\n";
                    $object .= '        $this->assertEquals($objDateTime->getMonth(),$this->_' .
                        strtolower($this->object_name) .'->get'.ucfirst($name). '()->getMonth());'."\n";
                    $object .= '        $this->assertEquals($objDateTime->getYear(),$this->_' .
                        strtolower($this->object_name) .'->get'.ucfirst($name). '()->getYear());'."\n";
                    $object .= '        $this->assertEquals($objDateTime->getMinutes(),$this->_' .
                        strtolower($this->object_name) .'->get'.ucfirst($name). '()->getMinutes());'."\n";
                    $object .= '        $this->assertEquals($objDateTime->getHour(),$this->_' .
                        strtolower($this->object_name) .'->get'.ucfirst($name). '()->getHour());'."\n";
                    $object .= '        $this->assertEquals($objDateTime->getSeconds(),$this->_' .
                        strtolower($this->object_name) .'->get'.ucfirst($name). '()->getSeconds());'."\n";
                    break;
                case 'time':
                    $time = "00:00:20";
                    ...
                    $object .= '        $this->_' . strtolower($this->object_name) . '->get' .
                        ucfirst($name) . '()->setTime("'.$time.'");'."\n";
                    $object .= '        $this->assertEquals($dtime->getHour(),$this->_' .
                        strtolower($this->object_name) . '->get' . ucfirst($name) . '()->getHour());'."\n";
                    $object .= '        $this->assertEquals($dtime->getMinutes(),$this->_' .
                        strtolower($this->object_name) . '->get' . ucfirst($name) . '()->getMinutes());'."\n";
                    $object .= '        $this->assertEquals($dtime->getSeconds(),$this->_' .
                        strtolower($this->object_name) . '->get' . ucfirst($name) . '()->getSeconds());'."\n";
                    break;
                case 'timestamp':
                    $object .= '        $objDateTime = new Date();'."\n";
                    $object .= '        $objDateTime->setDateTime(11, 12, 2000, 14, 10, 12);'."\n";
                    $object .= '        $this->_' . strtolower($this->object_name) .'->get'.
                        ucfirst($name). '()->setDateTime(11, 12, 2000, 14, 10, 12);'."\n";
                    $object .= '        $this->assertEquals($objDateTime->getDate(),$this->_' .
                        strtolower($this->object_name) .'->get'.ucfirst($name). '()->getDate());'."\n";
                    break;
                case 'year':
                    $object .= '        $this->_' . strtolower($this->object_name) . '->get' .
                        ucfirst($name) . '()->setValue(1990);'."\n";
                    $object .= '        $this->assertEquals(1990,$this->_' .
                        strtolower($this->object_name) . '->get' . ucfirst($name) . '()->getValue());'."\n";
                    break;
                case 'bigint':
                case 'decimal':
                case 'double':
                ...
                case 'tinyint':
                    $object .= '        $this->_' . strtolower($this->object_name) . '->get' .
                        ucfirst($name) . '()->setValue(24);'."\n";
                    $object .= '        $this->assertEquals(24,$this->_' .
                        strtolower($this->object_name) . '->get' . ucfirst($name) . '()->getValue());'."\n";
                    break;
                case 'bit':
                    $object .= '        $this->_' . strtolower($this->object_name) . '->get' .
                        ucfirst($name) . '()->setValue(1);'."\n";
                    $object .= '        $this->assertEquals(1,$this->_' .
                        strtolower($this->object_name) . '->get' . ucfirst($name) . '()->getValue());'."\n";
                    break;
                case 'char':
                    $object .= '        $this->assertTrue($this->_' .
                        strtolower($this->object_name) . '->set'.ucfirst($name).'("a"));'."\n";
                    $object .= '        $this->assertEquals("a",$this->_' .
                        strtolower($this->object_name) . '->get' . ucfirst($name) . '());'."\n";
                    break;
                default:
                    $object .= '        $this->assertTrue($this->_' .
                        strtolower($this->object_name) . '->set'.ucfirst($name).'("aaa"));'."\n";
                    $object .= '        $this->assertEquals("aaa",$this->_' .
                        strtolower($this->object_name) . '->get' . ucfirst($name) . '());'."\n";
                    break;
            }
            $object .= "    }\n\n";
    ...
    public function generateTestInsert()
    {
            ...
            if (!$field['primary_key']) {
                switch ($field['type']) {
                    ...
                    case 'bit':
                        ...
                        break;
                    case 'char':
                        $object .= '        $this->_'.strtolower($this->object_name).'->set'.
                            ucfirst($name).'("c");'."\n";
                        break;
                    default:
                        $object .= '        $this->_'.strtolower($this->object_name).'->set'.
        ...
        foreach ($this->fields as $name => $field) {
            if (!$field['primary_key']) {
                switch ($field['type']) {
                    case 'date':
                        $object .= '        $this->assertEquals(6,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getDay());'."\n";
                        $object .= '        $this->assertEquals(6,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getMonth());'."\n";
                        $object .= '        $this->assertEquals(2006,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getYear());'."\n";
                        break;
                    case 'datetime':
                        $object .= '        $this->assertEquals(11,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getDay());'."\n";
                        $object .= '        $this->assertEquals(12,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getMonth());'."\n";
                        $object .= '        $this->assertEquals(2000,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getYear());'."\n";
                        $object .= '        $this->assertEquals(14,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getHour());'."\n";
                        $object .= '        $this->assertEquals(10,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getMinutes());'."\n";
                        $object .= '        $this->assertEquals(12,$this->_'.strtolower($this->object_name).'->get'.
                    ...
                    case 'time':
                        ...
                        $object .= '        $this->assertEquals(00,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getMinutes());'."\n";
                        $object .= '        $this->assertEquals(30,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getSeconds());'."\n";
                        break;
                    case 'timestamp':
                        $object .= '        $this->assertEquals(11,$this->_'.strtolower($this->object_name).'->get'.
                        ...
                        break;
                    case 'year':
                        $object .= '        $this->assertEquals(1990,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getValue());'."\n";
                        break;
                    case 'bigint':
                    case 'decimal':
                    case 'double':
                    ...
                    case 'smallint':
                    case 'tinyint':
                        $object .= '        $this->assertEquals(24,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getValue());'."\n";
                        break;
                    case 'bit':
                        $object .= '        $this->assertEquals(1,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getValue());'."\n";
                        break;
                    case 'char':
                        $object .= '        $this->assertEquals("c",$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'());'."\n";
                        break;
                    default:
                        $object .= '        $this->assertEquals("carlos",$this->_'.strtolower($this->object_name).
                            '->get'.ucfirst($name).'()); '."\n";
                        break;
                }
            }
    ...
    public function generateTestUpdate()
    {
        ...
        foreach ($this->fields as $name => $field) {
            if (!$field['primary_key']) {
                switch ($field['type']) {
                    case 'date':
                        $object .= '        $this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->setDate(2,2,2002);'."\n";
                        break;
                    case 'datetime':
                        $object .= '        $this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->setDateTime(1, 1, 2000, 14, 10, 12);'."\n";
                        break;
                    case 'time':
                        $time = "00:00:25";
                        $object .= '        $this->_'.strtolower($this->object_name).'->get'.
                    ...
                    case 'tinyint':
                        $object .= '        $this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->setValue(25);'."\n";
                        break;
                    case 'bit':
                        $object .= '        $this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->setValue(0);'."\n";
                        break;
                    case 'char':
                        $object .= '        $this->_'.strtolower($this->object_name).'->set'.
                            ucfirst($name).'("j");'."\n";
        ...
        foreach ($this->fields as $name => $field) {
            if (!$field['primary_key']) {
                switch ($field['type']) {
                    case 'date':
                        $object .= '        $this->assertEquals(2,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getDay());'."\n";
                        $object .= '        $this->assertEquals(2,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getMonth());'."\n";
                        $object .= '        $this->assertEquals(2002,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getYear());'."\n";
                        break;
                    case 'datetime':
                        $object .= '        $this->assertEquals(1,$this->_'.strtolower($this->object_name).'->get'.
                    ...
                    case 'time':
                        ...
                        $object .= '        $this->assertEquals(00,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getMinutes());'."\n";
                        $object .= '        $this->assertEquals(25,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getSeconds());'."\n";
                        break;
                    case 'timestamp':
                        $object .= '        $this->assertEquals(1,$this->_'.strtolower($this->object_name).'->get'.
                        ...
                        break;
                    case 'year':
                        $object .= '        $this->assertEquals(1991,$this->_'.strtolower($this->object_name).'->get'.
                            ucfirst($name).'()->getValue());'."\n";
                        break;
                    case 'bigint':
                    case 'decimal':
                    ...
                    case 'smallint':
                    case 'tinyint':
                        $object .= '        $this->assertEquals(25,$this->_'.
                            strtolower($this->object_name).'->get'.ucfirst($name).'()->getValue());'."\n";
                        break;
                    case 'bit':
                        $object .= '        $this->assertEquals(0,$this->_'.
                            strtolower($this->object_name).'->get'.ucfirst($name).'()->getValue());'."\n";
                        break;
                    case 'char':
                        $object .= '        $this->assertEquals("j",$this->_'.
                            strtolower($this->object_name).'->get'.ucfirst($name).'());'."\n";
                        break;
                    default:
                        $object .= '        $this->assertEquals("jean",$this->_'.
                            strtolower($this->object_name).'->get'.ucfirst($name).'()); '."\n";
                        break;
                }
            }
    ...
    public function generateTestSearch()
    {
        ...
        $object .= '        $array = $this->_'.strtolower($this->object_name).
            '->search($param, null, null, false);'."\n";
        $object .= '        $this->assertEquals(1,count($array["'.$id.'"]));'."\n";
        $object .= '        $arrayYuju = $this->_'.strtolower($this->object_name).
            '->search($param, null, null, true);'."\n";
